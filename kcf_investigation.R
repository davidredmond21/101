...
#
kcf_sum <- read_excel("C:/Users/dredmond/Downloads/VES003_3.0.3/VES003_3.0.3/VES003_3.0.3/VES003_3.0.3/summary_stats_v7_json.xlsx")
...
x<-as.numeric(kcf_sum.x$kurtosis[(m-k):(m)])
y<-as.numeric(kcf_sum.y$kurtosis[(n-k):(n)])
#
