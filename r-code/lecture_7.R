...
# Lots of them are available on Github (later lecture). You can install a package from g
# ithub with
# library(devtools)
...
# Create a data frame that contains only the auto thefts. Then create a plot like the above to show the density of the crimes. Add a facet_wrap by the variable hour to see how the crimes vary by hour.
...
# See if you can combine the gganimate and ggmap packages to create an animated map of violent crimes
